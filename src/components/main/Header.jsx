...
export default function Header() {
  ...
  // ✅ Treat anything up to 1200px (including iPad Pro and iPad Air landscape) as mobile
  ...
  const priceCalculatorsDropdown = [
    ...
    },
    {
      ...
      path: "/price-calculators/kitchen/calculator/layout",
    },
    {
  ...
  const drawer = (
    <Box
      sx={{ width: "100%", height: "100%", pt: 2, pb: 10, overflowY: "auto" }}
    >
      <Box
        sx={{
          display: "flex",
        ...
        <ListItem disablePadding>
          <ListItemButton
            ...
            sx={{
              ...
              mb: 0.5,
              backgroundColor:
                location.pathname === "/projects" ? "#f0f0f0" : "transparent",
              "&:hover": { backgroundColor: "#f5f5f5" },
            }}
          >
            <ListItemText
        ...
        <ListItem disablePadding>
          <ListItemButton
            ...
            sx={{
              borderRadius: 1,
              mb: 0.5,
              backgroundColor: location.pathname.startsWith("/designs")
                ? "#f0f0f0"
                : "transparent",
              "&:hover": { backgroundColor: "#f5f5f5" },
            }}
          >
            <ListItemText
              primary="Designs"
              primaryTypographyProps={{
                fontWeight: location.pathname.startsWith("/designs")
                  ? "bold"
                  : "500",
        ...
        <ListItem disablePadding>
          ...
          >
            <ListItemText
              ...
              primaryTypographyProps={{
                fontWeight: location.pathname.startsWith("/price-calculators")
                  ? "bold"
                  : "500",
        ...
        {/* <ListItem disablePadding>
          <ListItemButton
            ...
            sx={{
              ...
              mb: 0.5,
              backgroundColor:
                location.pathname === "/faq" ? "#f0f0f0" : "transparent",
              "&:hover": { backgroundColor: "#f5f5f5" },
            }}
          >
            <ListItemText
        ...
        <ListItem disablePadding>
          <ListItemButton
            ...
            sx={{
              ...
              mb: 0.5,
              backgroundColor:
                location.pathname === "/contact" ? "#f0f0f0" : "transparent",
              "&:hover": { backgroundColor: "#f5f5f5" },
            }}
          >
            <ListItemText
                ...
                {navigationItems.map((item) =>
                  item.dropdown ? (
                    <Dropdown
                      ...
                      dropdownRender={() => {
                        const isPriceCalculator =
                          item.label === "Price Calculators";
                        return (
                          <Box
                            sx={{
                              display: isPriceCalculator ? "flex" : "grid",
                              flexDirection: isPriceCalculator
                                ? "column"
                                : "row",
                              gridTemplateColumns: isPriceCalculator
                                ? "none"
                                : "repeat(3, 1fr)",
                              gap: 1,
                              p: 2,
                    ...
                    <Dropdown
                      ...
                      dropdownRender={() => (
                        ...
                        >
                          ...
                          {offeringsData.exploreOfferings.map(
                            (offering, index) => (
                              <Box
                                key={index}
                                component={Link}
