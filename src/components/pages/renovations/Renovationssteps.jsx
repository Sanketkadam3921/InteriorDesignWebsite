...
const RenovationSteps = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "We handle everything—from design to delivery—ensuring complete peace of mind.",
    },
    {
      icon: "https://cdn-icons-png.flaticon.com/128/17659/17659898.png", // Certified experts
      title: "Certified experts",
      description:
        "Our skilled and verified professionals deliver top-quality craftsmanship and reliability.",
    },
  ];
