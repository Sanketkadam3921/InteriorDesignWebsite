...
export const INTRODUCTION_TEXT =
  "Our Modular Interiors offering brings intelligent design and smart engineering together to create spaces that are elegant, durable, and effortlessly functional. Whether it's your home, office, or a commercial space, our modular solutions are crafted to simplify your life while enhancing the aesthetics of every corner.";
...
export const CLOSING_CTA = {
  ...
  description:
    "Whether you're renovating or building a new space, our modular interiors bring efficiency, elegance, and personalization together—exactly the way modern living should be.",
