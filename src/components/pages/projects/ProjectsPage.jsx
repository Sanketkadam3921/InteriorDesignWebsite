...
export default function ProjectsPage() {
  ...
  const project = {
    ...
    color: "success",
    image:
      "https://ik.imagekit.io/bowr9614/DeliveredProjects/Page/DeliveredProj.jpg",
  };
    ...
    >
      ...
      <Box
        sx={{
          ...
          textAlign: "center",
          background:
            "linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.7)), url('https://ik.imagekit.io/bowr9614/DeliveredProjects/Page/Delivered2.jpg') center/cover",
          color: "white",
          p: { xs: 6, md: 10 },
        }}
      >
