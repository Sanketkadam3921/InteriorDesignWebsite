// Home Wallpaper Designs Data
export const wallpaperDesigns = [
  {
    id: "1",
    name: "Soft Contemporary with Organic Patterns Wallpaper",
    image:
    ...
    style: "Soft Contemporary with Organic Patterns",
    price: "₹1,20,000",
    area: "Wall Coverage",
  },
  {
    id: "2",
    name: "Botanical Nature-Inspired Mural Wallpaper",
    image:
    ...
    style: "Botanical Nature-Inspired Mural",
    price: "₹1,00,000",
    area: "Wall Coverage",
  },
  {
    id: "3",
    name: "Elegant Floral Classic Wallpaper",
    image:
    ...
    style: "Elegant Floral Classic",
    price: "₹1,50,000",
    area: "Wall Coverage",
  },
  {
    id: "4",
    name: "Tropical Serene Wallpaper",
    image:
  ...
  {
    id: "5",
    name: "Modern Minimalist with Botanical Accent Wallpaper",
    image:
    ...
    style: "Modern Minimalist with Botanical Accent",
    price: "₹1,30,000",
    area: "Wall Coverage",
  },
  {
    id: "6",
    name: "Tropical Minimal Wallpaper",
    image:
  ...
  {
    id: "7",
    name: "Artistic Scenic Wallpaper",
    image:
    ...
    style: "Artistic Scenic",
    price: "₹1,60,000",
    area: "Wall Coverage",
  },
  {
    id: "8",
    name: "Tropical Modern Wallpaper",
    image:
  ...
  {
    id: "9",
    name: "Luxe Contemporary Wallpaper",
    image:
  ...
  {
    id: "10",
    name: "Minimalist Botanical Scandinavian-Inspired Wallpaper",
    image:
    ...
    style: "Minimalist Botanical Scandinavian-Inspired",
    price: "₹1,05,000",
    area: "Wall Coverage",
  },
];

// Home Wallpaper Design Details Data
export const wallpaperDesignDetails = {
  1: {
    id: "1",
    title: "Soft Contemporary with Organic Patterns Wallpaper",
    category: "wallpaper",
    style: "Soft Contemporary with Organic Patterns",
    price: "₹1,20,000",
    image:
    ...
    features: [
      ...
      "Fine Gold Detailing",
      "Printed Wallpaper",
      "Sage Green, Cream, Gold Accents",
      "Bedroom Partial Accent Wall",
    ],
    specifications: {
      area: "Bedroom Partial Accent Wall",
      style: "Soft Contemporary with Organic Patterns",
      colorScheme: "Sage Green, Cream, Gold Accents",
  ...
  2: {
    id: "2",
    title: "Botanical Nature-Inspired Mural Wallpaper",
    category: "wallpaper",
    style: "Botanical Nature-Inspired Mural",
    price: "₹1,00,000",
    image:
    ...
    features: [
      ...
      "Matte-Finish Vinyl or Non-Woven",
      "Nature-Inspired Design",
      "Living Rooms, Feature Walls, Lounge Spaces",
    ],
    specifications: {
      area: "Living Rooms, Feature Walls, Lounge Spaces",
      style: "Botanical Nature-Inspired Mural",
      colorScheme: "Greens, Earthy Browns, Muted Reds, Soft Neutrals",
  ...
  3: {
    id: "3",
    title: "Elegant Floral Classic Wallpaper",
    category: "wallpaper",
    style: "Elegant Floral Classic",
    price: "₹1,50,000",
    image:
    ...
    features: [
      "Artistic Mural",
      "Frame-Like Panels",
      "Elegant Floral Classic",
      "Pastel Mauve, Beige, Soft Greys",
      "Bedroom Feature Wall",
    ],
    specifications: {
      area: "Bedroom Feature Wall",
      style: "Elegant Floral Classic",
      colorScheme: "Pastel Mauve, Beige, Soft Greys",
  ...
  4: {
    id: "4",
    title: "Tropical Serene Wallpaper",
    category: "wallpaper",
    style: "Tropical Serene",
    price: "₹1,10,000",
    image:
    ...
    features: [
      ...
      "Tropical Serene",
      "Soft Whites, Greens, Muted Blues",
      "Bedroom Feature Wall",
    ],
    specifications: {
      area: "Bedroom Feature Wall",
      style: "Tropical Serene",
      colorScheme: "Soft Whites, Greens, Muted Blues",
  ...
  5: {
    id: "5",
    title: "Modern Minimalist with Botanical Accent Wallpaper",
    category: "wallpaper",
    style: "Modern Minimalist with Botanical Accent",
    price: "₹1,30,000",
    image:
    ...
    features: [
      ...
      "Matte Finish",
      "Modern Minimalist with Botanical Accent",
      "Living Room Accent Wall",
    ],
    specifications: {
      area: "Living Room Accent Wall",
      style: "Modern Minimalist with Botanical Accent",
      colorScheme: "Neutral Beige, Taupe, Soft Greys",
  ...
  6: {
    id: "6",
    title: "Tropical Minimal Wallpaper",
    category: "wallpaper",
    style: "Tropical Minimal",
    price: "₹95,000",
    image:
    ...
    features: [
      ...
      "Subtle Tones",
      "Tropical Minimal",
      "Soft Greys, Greens, Neutrals",
      "Bedroom Feature Wall",
    ],
    specifications: {
      area: "Bedroom Feature Wall",
      style: "Tropical Minimal",
      colorScheme: "Soft Greys, Greens, Neutrals",
  ...
  7: {
    id: "7",
    title: "Artistic Scenic Wallpaper",
    category: "wallpaper",
    style: "Artistic Scenic",
    price: "₹1,60,000",
    image:
    ...
    features: [
      "High-Resolution Scenic Mural",
      "Artistic Scenic",
      "Moody Blues, Greys, Warm Neutrals",
      "Bedroom Accent Wall",
    ],
    specifications: {
      area: "Bedroom Accent Wall",
      style: "Artistic Scenic",
      colorScheme: "Moody Blues, Greys, Warm Neutrals",
  ...
  8: {
    id: "8",
    title: "Tropical Modern Wallpaper",
    category: "wallpaper",
    style: "Tropical Modern",
    price: "₹1,15,000",
    image:
    ...
    features: [
      ...
      "Smooth Finish",
      "Tropical Modern",
      "Greens, Soft Yellows, Muted Greys",
      "Bedroom Headboard Wall",
    ],
    specifications: {
      area: "Bedroom Headboard Wall",
      style: "Tropical Modern",
      colorScheme: "Greens, Soft Yellows, Muted Greys",
  ...
  9: {
    id: "9",
    title: "Luxe Contemporary Wallpaper",
    category: "wallpaper",
    style: "Luxe Contemporary",
    price: "₹1,40,000",
    image:
    ...
    features: [
      "Marble-Effect Art Panel",
      "Luxe Contemporary",
      "White, Blue, Beige",
      "Living Room Central Wall Panel",
    ],
    specifications: {
      area: "Living Room Central Wall Panel",
      style: "Luxe Contemporary",
      colorScheme: "White, Blue, Beige",
  ...
  10: {
    id: "10",
    title: "Minimalist Botanical Scandinavian-Inspired Wallpaper",
    category: "wallpaper",
    style: "Minimalist Botanical Scandinavian-Inspired",
    price: "₹1,05,000",
    image:
    ...
    features: [
      "Smooth Matte Wallpaper",
      "Non-Woven or Peel-and-Stick",
      "Minimalist Botanical",
      "Scandinavian-Inspired",
      "Reading Corners, Bedrooms, Calm Study Spaces",
    ],
    specifications: {
      area: "Reading Corners, Bedrooms, Calm Study Spaces",
      style: "Minimalist Botanical Scandinavian-Inspired",
      colorScheme: "Soft Beige, Muted Oranges, Olive Greens, Warm Neutrals",
...
// Home Wallpaper Category Configuration
export const wallpaperConfig = {
  categoryKey: "wallpaper",
  displayName: "Home Wallpaper",
  description:
    "Explore our curated collection of home wallpaper design concepts",
};
