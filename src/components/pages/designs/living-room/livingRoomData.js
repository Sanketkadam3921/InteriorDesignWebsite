...
export const livingroomDesigns = [
  {
    ...
    description:
      "Contemporary living room with comfortable seating and modern aesthetics",
    style: "Modern",
    price: "₹3,20,000",
    area: "200 sq ft",
  },
...
export const livingroomDesignDetails = {
  1: {
    ...
    description:
      "Contemporary living room with comfortable seating and modern aesthetics.",
    longDescription:
      "This modern living room design features comfortable seating, contemporary furniture, and a welcoming atmosphere.",
    images: [
