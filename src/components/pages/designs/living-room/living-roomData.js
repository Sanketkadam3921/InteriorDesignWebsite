export const livingroomDesignDetails = {
    "1": {
        id: "1",
        title: "Classic Living Room Design with Blue Leather Sofas and Marble Table",
        category: "living-room",
        style: "Classic",
        price: "₹3,80,000",
        image: "https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800",
        description: "A luxurious classic living room that blends comfort and sophistication with deep blue leather sofas, a marble coffee table, and elegant lighting.",
        specifications: {
    ...
    "2": {
        ...
        description: "A clean and contemporary living space featuring neutral colors, sleek furniture, and minimalist design principles for a sophisticated look.",
        specifications: {
    ...
    "3": {
        ...
        description: "A cozy Scandinavian-inspired living room featuring natural wood, light colors, and hygge elements for ultimate comfort and warmth.",
        specifications: {
